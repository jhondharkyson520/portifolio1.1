...
- **🖌️ Alternância de tema**: O usuário pode escolher entre o modo claro ou escuro para personalizar a interface conforme a preferência.
...
- 📂 **`src/components/`**: Componentes reutilizáveis, como:
  - **⬆️ ButtonScrollToTop**: Botão para voltar ao topo da página.
